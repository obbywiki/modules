...
function p.main(frame)
    ...
    local play_answer = string.format('You can play \'\'\'%s\'\'\' for free on Roblox. The game is %s to the public, meaning anyone with a Roblox account can join and start playing. Simply search for the game title on the Roblox website or mobile app to begin your adventure. Alternatively, you can directly click %s to reach the Roblox page.', obby_name, is_public and 'currently open' or 'currently set to private or unlisted', (data.root_place_id and '[https://roblox.com/games/' .. data.root_place_id .. '/ this link]' or ''))
